...
- `<tickets>.tickets` This is a cached manager like you are used to with [GuildChannelManager](https://discord.js.org/#/docs/main/stable/class/GuildChannelManager) for example, you can view more info [here](https://ghostdevv.github.io/djs-ticketsystem/classes/TicketChannelManager.html)
